...
def insert_into_billing(connection, user_id, month_year, usage_amount, bill_amount):
    try:
        with connection.cursor() as cursor:
            query = "INSERT INTO billing_data (user_id, month_year, usage_amount, bill_amount) VALUES (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE month_year = VALUES(month_year), usage_amount = VALUES(usage_amount), bill_amount = VALUES(bill_amount)"
